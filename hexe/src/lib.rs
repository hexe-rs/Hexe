...
//!
//! Once SIMD is stabilized, this feature will be made a default. By opting out,
//! Hexe can still compile using previous `rustc` versions without SIMD support.
//!
//! ## Compiler Flags
//!
//! Hexe may improve in performance if `rustc` is told to use features specific
